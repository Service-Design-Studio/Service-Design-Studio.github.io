...
<div style="padding-top: 25px; padding-bottom: 25px">
 <img src="{% link fall2021/p_ee_may.jpeg %}" alt="Ee May Kan" style="float: left; width: 200px; padding-right: 10px">
<h4>Ee May Kan</h4>
...
<div style="padding-top: 25px; padding-bottom: 25px">
 <img src="{% link fall2021/p_dylan.jpeg %}" alt="Dylan Tan" style="float: left; width: 200px; padding-right: 10px">
<h4>Dylan Tan</h4>
<a href="">Dylan</a> Bio. 
</div>
